...
struct joy_axes
{
  ...
  static const uint8_t JOY_AXIS_THROTTLE = 1;             //!< Joy axis number used for throttle control
  static const uint8_t JOY_AXIS_ROLL = 2;                 //!< Joy axis number used for roll control
  static const uint8_t JOY_AXIS_PITCH = 3;                //!< Joy axis number used for pitch control
  static const uint8_t JOY_AXIS_YAW = 0;                  //!< Joy axis number used for yaw control
