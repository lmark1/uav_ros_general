...
options = {
  ...
  use_inverse_covariance_weight = false,
...
TRAJECTORY_BUILDER_3D.num_accumulated_range_data = 1 -- 76
...
POSE_GRAPH.optimization_problem.huber_scale =  1 -- default 5e2 no loop closure with default
...
POSE_GRAPH.constraint_builder.max_constraint_distance = 10 -- default 15
